          ...
          <div className="space-y-4">
            ...
            {uploadedResume.parsedResume && (
              <div className="space-y-3">
                ...
                {uploadedResume.parsedResume.experience && (
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-2">
                      Experience: {uploadedResume.parsedResume.experience}
                    </p>
                  </div>
                )}

                {uploadedResume.parsedResume.education && (
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-2">
                      Education: {uploadedResume.parsedResume.education}
                    </p>
                  </div>
                )}
